...
function computeSheet(i, variant, hiddenAvance, f77Override) {
   ...
   * "ctt" (défaut) et "saisonnier" : coûts IDENTIQUES — en intérim saisonnier l'IFM et l'ICCP
   *   restent dues (L.1251-32/33 : il faudrait un accord étendu de la branche TT pour écarter
   *   l'IFM, il n'en existe pas — accord d'interprétation du 09/06/1998) et la RGDU garde ×1,1.
